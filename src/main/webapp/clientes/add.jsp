                ...
                <div class="col-lg-8 col-md-10 mx-auto">
                    ...
                    <form method="post">
                        ...
                        <div class="marginEntradaDados">
                            ...
                            <input type="email" name="email" class="form-control" placeholder="email@cia.com" required />
                        </div>
                        <div class="marginEntradaDados">
                            <label><b> Telefone </b></label><br/> 
                            <input type="tel" name="telefone" class="form-control" placeholder="99999-9999" required />
                        </div>
                        <div class="marginEntradaDados">
